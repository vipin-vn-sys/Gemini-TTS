...
export const AudioSparkIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M12 19.5v-15m6 6-6-6-6 6" />
    <path d="M8 10.5a5.5 5.5 0 1 0 8 0" />
    <path d="M18.5 14.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
    <path d="M5.5 14.5a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
  </svg>
);
